...
function check_inclusion(reach::Vector{<:AbstractPolytope}, output::Union{AbstractPolytope, PolytopeComplement})
    for poly in reach
...
function check_inclusion(reach::P, output::Union{AbstractPolytope, PolytopeComplement}) where P<:AbstractPolytope
